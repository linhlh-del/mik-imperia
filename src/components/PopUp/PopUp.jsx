...
import logoImperia from "../../assets/img/logo-imperia.png";
    ...
    <>
      ...
      <div className={styles.modal}>
        ...
        <div className={styles.container}>
          {/* Logo */}
          <img src={logoImperia} alt="Lusso Saigon" className={styles.logo} />

          {/* Title */}
          <h2>
            NHẬN BẢNG GIÁ VÀ CHÍNH SÁCH MỚI NHẤT <br /> IMPERIA VINHOMES GREEN
            PARADISE
          </h2>
